...
void Endstops::update() {
  ...
  #define UPDATE_ENDSTOP_BIT(AXIS, MINMAX) MARLIN_SET_BIT(current_endstop_bits, _ENDSTOP(AXIS, MINMAX), (READ(_ENDSTOP_PIN(AXIS, MINMAX)) != _ENDSTOP_INVERTING(AXIS, MINMAX)))
  // COPY_BIT: copy the value of SRC_BIT to DST_BIT in DST
  #define COPY_BIT(DST, SRC_BIT, DST_BIT) MARLIN_SET_BIT(DST, DST_BIT, TEST(DST, SRC_BIT))
